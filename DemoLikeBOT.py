...
API_TOKEN = "8084366011:AAFhrMQbP2RAtuytCVOgpJkFRHMExa-yUh8"
ALLOWED_GROUP_ID = -1002634908137
VIP_USER_ID = 7357694692
...
def join_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="📢 Join Channel", url="https://t.me/DEVOFFICIALX")],
    ])

def vip_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="📢 Join Channel", url="https://t.me/DEVOFFICIALX")],
        [InlineKeyboardButton(text="💎 Buy VIP", url="https://t.me/@DEVX75")],
    ])
